import tempfile  # create temporary file
import os
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Garlic chicken')
        ...
        recipe3 = sample_recipe(user=self.user, title='Mushroom and steak')
